...
import nhom5.quanao.KH_Loader.KH_DonHang_Loader;
import nhom5.quanao.R;

import java.util.ArrayList;


public class KH_TTDonHang1_Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getUser();
        if (khachHang != null) {
            KH_DonHang_Loader kh_donHang_loader = new KH_DonHang_Loader(context, recyclerView, linearLayout, linearDonHangEmpty, "yep","Chờ xác nhận");
